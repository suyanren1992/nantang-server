...
| 卡 | 内容 | 状态 |
|---|---|---|
| A-5 | 村落滑动卡片不居中 | 🟡 待施工（Claude Code） |
| A-6 | 注册/登录密码小眼睛回归 | 🟡 待施工（Claude Code） |
| A-12 | 社区动态点不进去 + 明晰用途 | 🟡 待施工（Claude Code） |
| A-7 | 校核确认后奖励 NT 没到账（排查+修复） | 🟡 待施工（Kimi Code） |
| A-9 | 确认劳动后未归档档案室 | ⏸ 等 A-7 排查结论，同一条链路，到时再出卡 |
