...
window.AppData = {
  ...
  updateTask: function(name, updates) { if (this._data.tasks[name]) Object.assign(this._data.tasks[name], updates); this._saveShared(); },
  deleteTask: function(name) { delete this._data.tasks[name]; this._saveShared(); },
