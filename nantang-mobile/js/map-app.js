...
var HARDCODED_BUILDINGS = [
  { id:'toilet_b',name:'公共厕所',icon:'🚻',meta:'1F·🔴超时2天',photo:'https://placehold.co/600x360/d8c8b8/5a3a3a?text=厕所',photoBg:'linear-gradient(160deg,#e8e0d0,#d8d0b8)',status:'red',summary:{status:'📍办公楼1F',cleanliness:,items:'🧻卫生纸剩3卷',alert:'⚠急需打扫'},floors:{},plots:[],linkedTasks:['打扫厕所','补卫生纸']},
  ...
  { id:'study',name:'大地书房',icon:'🏯',meta:'3层·12间·🟢整洁',photo:'https://placehold.co/600x360/c8b898/6a5a40?text=大地书房',photoBg:'linear-gradient(160deg,#d8d0c0,#c8b898)',status:'green',summary:{cleanliness:'🟢4 🟡1',items:'📚200册',onsite:,stay:,fee:},floors:{'1F':[{id:'mahjong',name:'麻将室',icon:'🀄',status:'green',sub:,items:[{icon:'🀄',text:'麻将桌×2',sub:,status:'clean'}],people:[],cleaning:[{t:'擦拭桌面',status:}],linkedTasks:[]},{id:'reading',name:'大书房',icon:'📚',status:'green',sub:,items:[{icon:'📚',text:'藏书·200册',sub:,status:'clean'}],people:[{icon:'👤',text:,sub:'在看书'}],cleaning:[{t:'整理书架',status:}],linkedTasks:[]}],'2F':[{id:'dorm101',name:'101室',icon:'🛏',status:'yellow',sub:,items:[{icon:'🛏',text:,sub:,status:'clean'}],people:[],cleaning:[{t:'整理床铺',status:}],linkedTasks:[]},{id:'dorm102',name:'102室',icon:'🛏',status:'green',sub:'空房',items:[],people:[],cleaning:[],linkedTasks:[]},{id:'dorm103',name:'103室',icon:'🛏',status:'yellow',sub:,items:[{icon:'🛏',text:,sub:,status:'clean'}],people:[],cleaning:[],linkedTasks:[]},{id:'dorm104',name:'104室',icon:'🛏',status:'green',sub:'空房',items:[],people:[],cleaning:[],linkedTasks:[]},{id:'dorm105',name:'105室',icon:'🛏',status:'green',sub:'空房',items:[],people:[],cleaning:[],linkedTasks:[]},{id:'dorm106',name:'106室',icon:'🛏',status:'green',sub:'空房',items:[],people:[],cleaning:[],linkedTasks:[]}],'阁楼':[{id:'attic',name:'阁楼储物',icon:'📦',status:'green',sub:,items:[],people:[],cleaning:[],linkedTasks:[]}]}},
...
function renderInfoPage() {
  ...
  h += '<div class="avatar-list">'+
    '<div class="av-chip" onclick="jumpTo(\'office\')"><span class="av-circle">👤</span><span class="av-name"></span><span class="av-at">🍳厨房做饭</span></div>'+
    '<div class="av-chip" onclick="jumpTo(\'study\')"><span class="av-circle">👤</span><span class="av-name"></span><span class="av-at">📖大书房看书</span></div>'+
    '<div class="av-chip" onclick="jumpTo(\'office\')"><span class="av-circle">👤</span><span class="av-name"></span><span class="av-at">🎨画室画画</span></div>'+
  '</div>';
  ...
  h += '<div class="ic-card" onclick="openMgmt(\'cleaning\')"><div class="ic-head">🧹 下次大扫除</div>'+
    '<div class="ic-body"><div class="ic-big">3 天</div><div>📅 7月18日 · 周六</div><div style="color:var(--g-text-dim);font-size:.65rem">负责人：待认领</div></div></div>';

  // 入住
  h += '<div class="ic-card" onclick="openMgmt(\'stay\')"><div class="ic-head">🛏️ 住宿</div>'+
    '<div class="ic-body"><div><b></b> 101室 · 7/15→20 · 150NT</div><div><b></b> 103室 · 7/15→18 · 90NT</div><div style="color:var(--g-text-dim);font-size:.65rem">4间空房 · 💰待收240NT</div></div></div>';
  ...
  h += '<div class="ic-card" onclick="openMgmt(\'kitchen\')"><div class="ic-head">🍳 厨房物品</div>'+
    '<div class="ic-body"><div>🧊 冰箱上层 · 放入 · 7/12</div><div style="color:#c8892e">📦 白菜 · ⚠3天后过期</div><div style="color:var(--g-text-dim);font-size:.65rem">🍳灶台·🪑餐桌·🚿水槽正常</div></div></div>';
  ...
  h += '<div class="alert-row" onclick="jumpTo(\'toilet_b\')"><span>🔴</span> 公共厕所 · 打扫超时2天 · 待轮值</div>';
...
var MGMT_DATA = {
  cleaning: {
    ...
    history: [
      { date:'7/08', person:, roomName:'画室', nt:5, note:'日常维护' },
      { date:'7/01', person:, roomName:'厕所', nt:20, note:'大扫除' }
    ]
  },
  stay: {
    ...
    history: [
      { date:'7/15', person:, room:'101', detail:'入住 7/15→20·5天·150NT' },
      { date:'7/15', person:, room:'103', detail:'入住 7/15→18·3天·90NT' }
    ]
  },
  field: {
    history: [
      { date:'7/12', person:, plotName:'A区', action:'浇水', note:'番茄长势良好' },
      { date:'7/10', person:, plotName:'C区', action:'施肥', note:'红薯追肥' }
    ]
  },
  kitchen: {
    history: [
      { date:'7/12', person:, action:'放入物品', item:'鸡蛋×12', location:'冰箱上层' },
